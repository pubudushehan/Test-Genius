  ...
  return (
    <div className="relative min-h-screen pt-16">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1513258496099-48168024aec0?ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80')",
          top: '64px',
        }}
      >
      ...
      <div className="relative min-h-[calc(100vh-64px)] flex items-center">
        <div className="container mx-auto px-4 py-12 md:py-20">
          ...
          >
            ...
            >
              Unlock your potential with our comprehensive ICT education platform. 
              Experience interactive learning, real-time assessments, and personalized guidance.
            </motion.p>
