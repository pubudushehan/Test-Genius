            ...
            <div className="relative backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
              ...
              <div className="relative p-8">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-200">Sign in to continue to Test Genius</p>
                </div>
                ...
                <form onSubmit={handleEmailSignIn} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
                  >
                    Sign in
                  </button>
                </form>
